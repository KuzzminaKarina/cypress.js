describe('Тестирование формы логина', function () {
   ...
   it('Проверяю нажатие на кнопку «Забыли пароль»', function () {
        cy.visit('https://login.qa.studio/');
   ...
   it('Ввожу НЕ верный логин и верный пароль', function () {
        cy.visit('https://login.qa.studio/');
        cy.get('#mail').type('karina@mail.ru');
        cy.get('#pass').type('iLoveqastudio1');
        cy.get('#loginButton').click();
        cy.contains('Такого логина или пароля нет').should('be.visible');
        cy.get('#exitMessageButton > .exitIcon').should('be.visible');
   ...
   it('Ввожу НЕ верный логин (без @) и верный пароль', function () {
        cy.visit('https://login.qa.studio/');
        cy.get('#mail').type('karinamail.ru');
        cy.get('#pass').type('iLoveqastudio1');
        cy.get('#loginButton').click();
